...
void AAuraEnemy::PossessedBy(AController* NewController)
{
	...
	AuraAIController->GetBlackboardComponent()->SetValueAsBool(FName("RangedAttacker"), CharacterClass != ECharacterClass::Melee);
...
void AAuraEnemy::BeginPlay()
{
	...
	if (const UAuraAttributeSet* AuraAS = CastChecked<UAuraAttributeSet>(AttributSet))
	{
