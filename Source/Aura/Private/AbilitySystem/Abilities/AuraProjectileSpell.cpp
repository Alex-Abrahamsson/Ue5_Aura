...
void UAuraProjectileSpell::SpawnProjectile(const FVector& ProjectileTargetLocation, FGameplayTag ProjectileTag)
{
	...
	if (CombatInterface)
	{
		...
		SpecHandle.Data->AddDynamicAssetTag(ProjectileTag);
